        ...
        <div class="row px-xl-5">
            <div class="col-lg-5 mb-30">
                <a href="{{route('user#home')}}" class="text-decoration-none">
                    <i class="fa-solid fa-arrow-left me-3 text-danger fs-3"></i>
                </a>
            ...
            <div class="col-lg-7 h-auto mb-30 mt-4">
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex mb-3">
                        ...
                        <small class="pt-1">{{$pizza->view_count+1}}<i class="fa-brands fa-ups ms-2"></i></small>
                    </div>
                ...
                <div class="owl-carousel related-carousel">
                   ...
                   <div class="product-item bg-light">
                    <div class="product-img position-relative overflow-hidden">
                        <img class="img-fluid w-100" style="height: 500px" src="{{asset('storage/'.$p->image)}}" alt="">
